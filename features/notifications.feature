Feature: Notifications
  ...
  Rule: Message persistence is the authoritative trigger for notifications
    ...
    Scenario: Persisted message increments unread count for other members
      ...
      And a durable notification record is stored for "Noah"
    ...
    Scenario: Message author does not receive their own unread increment
      ...
      And no durable notification record is stored for "Olivia"
    ...
    Scenario: Failed message creation does not enqueue notifications
      ...
      And no durable notification record is stored for "Noah"
  ...
  Rule: Live message delivery follows category preferences for connected authorized recipients
    ...
    Scenario: Connected recipient receives a message-created live notification
      When "Olivia" posts a message in channel "general"
      Then "Noah" receives a message-created live notification for channel "general"

    Scenario: Connected recipient receives a mentioned live notification
    ...
    Scenario: Connected recipient receives an unread-message live notification
    ...
    Scenario: Connected recipient with all-messages default receives a mentioned live notification
      Given "Noah" has all-messages channel default notifications
      When "Olivia" posts a message mentioning "Noah" in channel "general"
      Then "Noah" receives a mentioned live notification for channel "general"

    Scenario: Connected recipient with only-mentions default does not receive unread-message live notifications
      Given "Noah" has only-mentions channel default notifications
      When "Olivia" posts a plain message in channel "general"
      Then "Noah" does not receive live notifications for channel "general"

    Scenario: Connected recipient with only-mentions default receives a mentioned live notification
      Given "Noah" has only-mentions channel default notifications
      When "Olivia" posts a message mentioning "Noah" in channel "general"
      Then "Noah" receives a mentioned live notification for channel "general"

    Scenario: Connected recipient with none default does not receive unread-message live notifications
      Given "Noah" has none channel default notifications
      When "Olivia" posts a plain message in channel "general"
      Then "Noah" does not receive live notifications for channel "general"

    Scenario: Connected recipient with none default does not receive mentioned live notifications
      Given "Noah" has none channel default notifications
      When "Olivia" posts a message mentioning "Noah" in channel "general"
      Then "Noah" does not receive live notifications for channel "general"
  ...
  Rule: Live message delivery respects mute precedence for connected authorized recipients
    ...
    Scenario: Globally muted recipient does not receive mentioned live notifications
      Given "Noah" has globally muted notifications
      When "Olivia" posts a message mentioning "Noah" in channel "general"
      Then "Noah" does not receive live notifications for channel "general"

    Scenario: Globally muted recipient does not receive unread-message live notifications
      Given "Noah" has globally muted notifications
      When "Olivia" posts a plain message in channel "general"
      Then "Noah" does not receive live notifications for channel "general"

    Scenario: Muted server recipient does not receive mentioned live notifications
      Given "Noah" has muted server "Test"
      When "Olivia" posts a message mentioning "Noah" in channel "general"
      Then "Noah" does not receive live notifications for channel "general"

    Scenario: Muted server recipient does not receive unread-message live notifications
      Given "Noah" has muted server "Test"
      When "Olivia" posts a plain message in channel "general"
      Then "Noah" does not receive live notifications for channel "general"

    Scenario: Temporarily muted channel recipient does not receive unread-message live notifications until unmuted
  ...
  Rule: Live message delivery recovers by category after temporary channel mute expires
    ...
    Scenario: Temporarily muted channel recipient does not receive mentioned live notifications until unmuted
      Given "Noah" has only-mentions channel default notifications
  ...
  Rule: Live friend request delivery reaches connected recipients
    ...
    Scenario: Connected addressee receives a friend-request-received live notification
      Given "Noah" is subscribed to live notifications
      When "Olivia" sends a friend request to "Noah"
      Then "Noah" receives a friend-request-received live notification from "Olivia"

    Scenario: Connected requester receives a friend-request-accepted live notification
  ...
  Rule: Live voice events are delivered to other members and not echoed to the joining user
    ...
    Scenario: Connected recipient receives a friend-joined-voice live notification
      Given "Noah" is subscribed to live notifications
    ...
    Scenario: Joining user does not receive their own friend-joined-voice live notification
      Given "Olivia" is subscribed to live notifications
      When "Olivia" connects to voice for channel "voice-lobby"
      Then "Olivia" does not receive live notifications for channel "voice-lobby"

    Scenario: Connected recipient with all-messages default receives a friend-joined-voice live notification
      Given "Noah" has all-messages channel default notifications
      And "Noah" is subscribed to live notifications
      When "Olivia" connects to voice for channel "voice-lobby"
      Then "Noah" receives a friend-joined-voice live notification for channel "voice-lobby" from "Olivia"

    Scenario: Connected recipient with only-mentions default receives a friend-joined-voice live notification
      Given "Noah" has only-mentions channel default notifications
      And "Noah" is subscribed to live notifications
      When "Olivia" connects to voice for channel "voice-lobby"
      Then "Noah" receives a friend-joined-voice live notification for channel "voice-lobby" from "Olivia"

    Scenario: Connected recipient with none default receives a friend-joined-voice live notification
      Given "Noah" has none channel default notifications
      And "Noah" is subscribed to live notifications
      When "Olivia" connects to voice for channel "voice-lobby"
      Then "Noah" receives a friend-joined-voice live notification for channel "voice-lobby" from "Olivia"

    Scenario: Globally muted recipient still receives a friend-joined-voice live notification
      Given "Noah" has globally muted notifications
      And "Noah" is subscribed to live notifications
      When "Olivia" connects to voice for channel "voice-lobby"
      Then "Noah" receives a friend-joined-voice live notification for channel "voice-lobby" from "Olivia"

    Scenario: Muted server recipient still receives a friend-joined-voice live notification
      Given "Noah" has muted server "Test"
      And "Noah" is subscribed to live notifications
      When "Olivia" connects to voice for channel "voice-lobby"
      Then "Noah" receives a friend-joined-voice live notification for channel "voice-lobby" from "Olivia"

    Scenario: Temporarily muted voice channel recipient still receives a friend-joined-voice live notification
  ...
  Rule: Live voice events only target authorized server members
    ...
    Scenario: Unauthorized recipient does not receive friend-joined-voice live notifications
      Given "Noah" is subscribed to live notifications
      When "Olivia" connects to voice for channel "voice-lobby"
      Then "Noah" does not receive live notifications for channel "voice-lobby"
  ...
  Rule: Notification policy precedence controls unread increments
    ...
    Scenario: Muted server suppresses channel notification increments
      ...
      When "Olivia" posts a message in channel "engineering"
      Then unread count for "Noah" in channel "engineering" is zero
      And no durable notification record is stored for "Noah" for the last message
    ...
    Scenario: Preference views reflect global, server, and channel mute state
      Given "Noah" has globally muted notifications
      And "Noah" has muted server "Test"
