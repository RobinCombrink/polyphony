...
Always run dart analyze and flutter test after every change to flutter to ensure that all dependencies are up to date and the latest code changes are compiled.
