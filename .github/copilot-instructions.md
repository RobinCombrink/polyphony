...
- Always prioritise using standard library types and traits over custom implementations; for example, prefer `From<T>`/`TryFrom<T>` for conversions over custom implementations.
